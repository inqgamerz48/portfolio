...
export const metadata: Metadata = {
  ...
  description: 'Portfolio of Sriram Satya Srivatsa Nanduri (INQ) - Full Stack Developer, AI-Integrated Systems, Product Builder. 4+ years shipping production applications.',
